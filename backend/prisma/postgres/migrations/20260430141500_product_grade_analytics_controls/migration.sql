CREATE TABLE "PrivacySetting" (
  ...
  "domainAllowlist" JSONB NOT NULL DEFAULT '[]'::jsonb,
  "sensitiveSelectors" JSONB NOT NULL DEFAULT '["[data-nudgr-redact]","[data-private]","[data-sensitive]"]'::jsonb,
...
CREATE TABLE "EventDefinition" (
  ...
  "owner" TEXT,
  "requiredProperties" JSONB NOT NULL DEFAULT '[]'::jsonb,
  "optionalProperties" JSONB NOT NULL DEFAULT '[]'::jsonb,
